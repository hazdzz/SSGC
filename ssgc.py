...
def get_parameters():
    ...
    model_save_path = model_name + '_' + gso_type + '_' + str(K) + '_order' + str(beta) + '.pth'
    model_save_path = os.path.join(model_save_dir, model_save_path)

    return device, dataset, model_name, gso_type, lr, weight_decay, enable_bias, K, beta, epochs, opt, early_stopping_patience, model_save_path
...
if __name__ == "__main__":
    device, dataset, model_name, gso_type, lr, weight_decay, enable_bias, K, beta, epochs, opt, early_stopping_patience, model_save_path = get_parameters()
